...
class LifecycleLog {
 public:
  static void RecordConstruction(const char* name) { ConstructionStorage().emplace_back(name); }

  static void RecordDestruction(const char* name) { DestructionStorage().emplace_back(name); }
  ...
  static const std::vector<std::string>& Construction() { return ConstructionStorage(); }

  static const std::vector<std::string>& Destruction() { return DestructionStorage(); }
