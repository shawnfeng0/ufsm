...
FSM_STATE_MACHINE(MultiLayerMachine, StateA) {
    int counter = 0;
};
...
FSM_STATE(StateAA, StateA, StateAAA) {
    TRACK_LIFECYCLE(StateAA);
};

FSM_STATE(StateAAA, StateAA, StateAAAA) {
    TRACK_LIFECYCLE(StateAAA);
};
...
// StateAB hierarchy
FSM_STATE(StateAB, StateA, StateABA) {
    TRACK_LIFECYCLE(StateAB);
};
...
FSM_STATE(StateABAA, StateABA, StateABAAA) {
    TRACK_LIFECYCLE(StateABAA);
};

FSM_STATE(StateABAAA, StateABAA) {
    TRACK_LIFECYCLE(StateABAAA);
};
...
FSM_STATE(StateBA, StateB) {
    TRACK_LIFECYCLE(StateBA);
};

// StateC (simple state, no substates)
FSM_STATE(StateC, MultiLayerMachine) {
    TRACK_LIFECYCLE(StateC);
};
